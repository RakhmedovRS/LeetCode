...
@LeetCode(
        ...
        url = "https://leetcode.com/problems/count-substrings-that-can-be-rearranged-to-contain-a-string-ii/description/",
        difficulty = Difficulty.HARD
)
public class CountSubstringsThatCanBeRearrangedToContainStringII {
